...
public class SideScroller extends Application {
     ...
     * </pre>
     * <p>
     * this object is passed to {@link Scene} object in {@link SideScroller#start(Stage)} method.
     */
     ...
     * {@link Scene} represents the holder of all your JavaFX {@link javafx.scene.Node}s.<br>
     * {@link javafx.scene.Node} is the super class of every javaFX class.
     * </p>
     *
    ...
    private Region createOptionsBar() {
        ...
        CheckMenuItem grid = createCheckMenuItem("Grid", board.getDrawGrid(), board.drawGridProperty());
